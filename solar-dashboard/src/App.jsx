...
const ENTITIES = {
  ...
  dynamicInterval: 'select.ep_dynamic_interval',
...
const styles = {
  ...
  tabs: {
    ...
    gap: '4px',
    marginBottom: '16px',
    borderBottom: '2px solid var(--divider-color, #e5e7eb)',
    paddingBottom: '0',
  },
  tab: (active) => ({
    padding: '8px 16px',
    ...
    color: active ? 'var(--primary-text-color, #212121)' : 'var(--secondary-text-color, #6b7280)',
